          ...
          <div className="container flex flex-wrap items-center justify-between mx-auto">
            <a href="/" className="flex items-center">
              <span className="self-center text-2xl whitespace-nowrap text-black 4xl:text-4xl">
                Welf<span className="text-2xl text-blue-600 4xl:text-4xl">.</span>
              </span>
            </a>
    ...
    largeScreen: 'full',
            ...
            {open &&
               <div className="w-screen bg-white py-4 px-3 flex flex-col items-center mx-auto justify-center text-center">
                <ul>
                    <li className="text-black my-2"><a href="/">Home</a></li>
                    <li className="text-black mt-2"><a href="/explore">Proposals</a></li>
                    <li className="text-black my-2"><a href="/onboard">Join DAO</a></li>
                    <li className="text-black my-2"><a href="/dashboard">Dashboard</a></li>
                </ul>
               </div>
        }
            <div
